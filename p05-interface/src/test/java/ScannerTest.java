...
public class ScannerTest {
    ...
    public void testNumbers() {
        ...
        s.next();
        Assertions.assertEquals(new NumberSymbol(42), s.current());
        s.next();
    ...
    public void testIdentifiers() {
        ...
        s.next();
        Assertions.assertEquals(new IdentifierSymbol("hello"), s.current());
        s.next();
    ...
    public void testSpecials() {
        final Scanner s = new ScannerImpl(new StringReader("/* +-"));
        s.next();
        Assertions.assertEquals(SpecialSymbol.DIV, s.current());
        s.next();
